...
const Screencards = ({ cardDetails }) => {
  ...
  return (
    <div ref={elementRef} style={{ transform: `rotate(${rotation}deg)` }} className={`${cardDetails.classes} ${'lg:rotate'} w-full lg:w-[70%] mt-20 border-x border-y border-gray-700 rounded-lg flex flex-col pb-4`}>
